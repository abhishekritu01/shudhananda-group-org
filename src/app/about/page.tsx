...
const hospitalsList = [
  ...
  { slug: 'cureplus-dharani-hospital', name: 'CurePlus  Dharani Hospital', image: '/hospital/dharni.png' },
  { slug: 'cureplus-kaveri-hospital', name: 'CurePlus  Kaveri Hospital', image: '/hospital/kaveri.png' },
  { slug: 'cureplus-krishna-hospital', name: 'CurePlus  Krishna Hospital', image: '/hospital/krishna.png' },
  { slug: 'cureplus-narasegowda-memorial-hospital', name: 'CurePlus  Narasegowda Memorial Hospital', image: '/hospital/Narasegowda.png' },
  { slug: 'cureplus-hospital-shanivarasanthe', name: 'CurePlus  Shanivarasanthe Hospital', image: '/hospital/Shanivarasanth.png' },
  { slug: 'cureplus-hospital-ramapura', name: 'CurePlus  Ramapura Hospital', image: '/hospital/Ramapura.png' },
  { slug: 'cureplus-hospital-terakanambi', name: 'CurePlus  Terakanambi Hospital', image: '/hospital/Terakanambi.png' },
  { slug: 'cureplus-hospital-bherya', name: 'CurePlus  Bherya Hospital', image: '/hospital/Bherya.png' },
  { slug: 'cureplus-hospital-t-narasipura', name: 'CurePlus  T. Narasipura Hospital', image: '/hospital/T. Narasipura.png' },
  { slug: 'cureplus-hospital-handpost', name: 'CurePlus  Handpost Hospital', image: '/hospital/Handpost.png' },
  { slug: 'cureplus-hospital-hosur', name: 'CurePlus  Hosur Hospital', image: '/hospital/Hosur.png' },
  { slug: 'cureplus-hospital-halli-mysore', name: 'CurePlus  Halli Mysore Hospital', image: '/hospital/Halli Mysore.png' },
];
...
const AboutPage = () => {
  return (
    <>
      <Head>
        <link rel="canonical" href="https://www.cureplushospitals.com/about" />
        <title>About | CurePlus Hospitals</title>
      </Head>
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 text-gray-800">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
            CurePlus Hospitals is committed to transforming rural healthcare across India, proudly
            recognized as a Best Hospitals in Karnataka for its patient-first approach and
            affordable care.
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg leading-relaxed text-gray-700">
            Founded in August 2013 by Dr. Arjun Sachidanand and Dr. Sini Arjun, Sudhanand
            Healthcare Solutions Pvt. Ltd. is dedicated to delivering high-quality healthcare services
            at subsidized rates in India and globally. Central to its mission are the esteemed
            CurePlus Hospitals, exemplifying the company’s commitment to healthcare
            excellence.
            <br /><br />
            The organization aims to establish, manage, and promote healthcare facilities that offer
            comprehensive services including preventive care, diagnostics, telemedicine, and
            educational initiatives. This holistic approach underscores its dedication to enhancing
            healthcare accessibility and quality.

            <br /><br />
            Sudhanand Healthcare Solutions Pvt. Ltd. focuses on setting up healthcare centers that
            cater to both rural and urban underserved populations, contributing significantly to
            improving health outcomes across India. This effort is supported by Dr. M. D.
            Sachidananda Murthy Memorial Hospitals and an expanding network of CurePlus
            Hospitals, solidifying its position as a Top Hospital in Karnataka.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {hospitalsList.map((hospital, index) => (
              <Link href={`/hospital/${hospital.slug}`} key={index}>
                <motion.div
                  className="group relative overflow-hidden rounded-xl bg-white shadow-md hover:shadow-lg transition-all border border-gray-100"
                  variants={fadeUp}
                  custom={index + 10}
