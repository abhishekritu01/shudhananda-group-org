    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-zinc-600 max-w-4xl mx-auto leading-relaxed">
          CurePlus Hospitals, part of Sudhanand Health Care Solutions, is redefining rural
          healthcare with its expanding network across Karnataka. We provide 24/7 medical care,
          advanced diagnostics, and affordable medicines through&nbsp;
          <a
            href="https://www.sudhanandpharmacies.com/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-inherit hover:text-purple-700 no-underline transition-colors duration-200"
          >
            CurePlus Pharma
          </a>
          .
          <br /><br />
          Recognized as a Best Hospitals in Karnataka, we are committed to delivering quality,
          accessible, and compassionate treatment for all. CurePlus ensures world-class
          healthcare reaches even the most remote communities.
        </p>
