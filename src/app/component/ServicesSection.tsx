    ...
    <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        <p className="text-lg text-zinc-600 leading-relaxed">
          Recognized as a Top Hospitals in Karnataka,&nbsp;
          <Link
            href="/ourhospitals" // Replace with actual route
            className="text-inherit hover:text-purple-700 transition-colors duration-200 no-underline"
          >
            CurePlus Hospitals
          </Link>{' '}
          delivers compassionate, innovative, and accessible healthcare. From emergency care to
          diagnostics and pharmacy, we provide complete medical solutions tailored to every need.
        </p>
      </div>
