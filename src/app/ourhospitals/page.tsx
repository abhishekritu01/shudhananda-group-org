...
const HospitalsPage = () => {
  const hospitals = [
    ...
    { slug: 'cureplus-kaveri-hospital', name: 'CurePlus  Kaveri Hospital', image: '/hospital/kaveri.png', phone: '08276 298998' },
    { slug: 'cureplus-krishna-hospital', name: 'CurePlus  Krishna Hospital', image: '/hospital/krishna.png', phone: '08223-275798' },
    { slug: 'cureplus-narasegowda-memorial-hospital', name: 'CurePlus  Narasegowda Memorial Hospital', image: '/hospital/Narasegowda.png', phone: '08236-200466' },
    { slug: 'cureplus-hospital-shanivarasanthe', name: 'CurePlus Hospital  Shanivarasanthe', image: '/hospital/Shanivarasanth.png', phone: '9035193777' },
    { slug: 'cureplus-hospital-ramapura', name: 'CurePlus Hospital  Ramapura ', image: '/hospital/Ramapura.png', phone: '08225-272200' },
    { slug: 'cureplus-hospital-terakanambi', name: 'CurePlus Hospital  Terakanambi', image: '/hospital/Terakanambi.png', phone: '08229-222044' },
    { slug: 'cureplus-hospital-bherya', name: 'CurePlus Hospital Bherya ', image: '/hospital/Bherya.png', phone: '08223-200604' },
    { slug: 'cureplus-hospital-t-narasipura', name: 'CurePlus Hospital  T. Narasipura', image: '/hospital/T. Narasipura.png', phone: '08227-200940' },
    { slug: 'cureplus-hospital-handpost', name: 'CurePlus Hospital Handpost ', image: '/hospital/Handpost.png', phone: '8228257300' },
    { slug: 'cureplus-hospital-hosur', name: 'CurePlus Hospital Hosur ', image: '/hospital/Hosur.png', phone: '9035193777' },
    { slug: 'cureplus-hospital-halli-mysore', name: 'CurePlus Hospital Halli Mysore ', image: '/hospital/Halli Mysore.png', phone: '08175-273114' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUp}>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Cureplus Hospitals is a growing network of healthcare facilities across the districts of
                Mysore, Chamarajanagar, Kodagu, Mandya, and Hassan committed to providing
                accessible, affordable, and high-quality medical care.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                From urban centers to underserved regions, Cureplus Hospitals have established
                themselves as trusted healthcare providers, known for consistent, high-quality care and
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <AnimatePresence>
              {hospitals.map((hospital, index) => (
                <Link href={`/hospital/${hospital.slug}`} key={index} passHref>
                  <motion.div
