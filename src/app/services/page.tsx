      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 text-gray-800">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-7xl mx-auto">
            At CurePlus Hospitals, we are proud to be recognized as a Best Hospitals in Karnataka,
            delivering a wide range of accessible, high-quality healthcare services across both rural
            and urban communities.
            Our integrated care model ensures that every patient receives the right treatment at the
            right time-from primary care and emergency services to advanced diagnostics, surgical
            procedures, telemedicine, and pharmaceutical support. Each facility is equipped with
            modern medical infrastructure and operated by skilled professionals dedicated to
            compassionate, affordable care.
            By bridging the healthcare gap in underserved regions, we strive to create a healthier,
            stronger Karnataka-one patient, one family, and one community at a time.
          </p>
        </motion.div>
