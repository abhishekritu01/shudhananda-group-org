...
const hospitalsList = [
  ...
  { id: 6, name: 'CurePlus Hospital Shanivarasanthe ', image: '/Shanivarasanthe/shanivarasanthe.png', status: 'normal' ,phone:'9035193777' },
  { id: 7, name: 'CurePlus Hospital Ramapura ', image: '/rampura/rampura.png', status: 'featured' ,phone:'08225-272200' },
  { id: 8, name: 'CurePlus Hospital Terakanambi ', image: '/terakanamb/terakanamb.png', status: 'normal' ,phone:'08229-222044' },
  { id: 9, name: 'CurePlus Hospital Bherya ', image: '/bheraya/bheraya.png', status: 'popular' ,phone:'08223-200604' },
  { id: 10, name: 'CurePlus Hospital T. Narasipura ', image: '/Narasipura/Narasipura.png', status: 'normal' ,phone:'08227-200940' },
  { id: 11, name: 'CurePlus Hospital Handpost', image: '/HandPost/HandPost1.png', status: 'featured' ,phone:'8228257300' },
  { id: 12, name: 'CurePlus Hospital Hosur ', image: '/hosur/hosur.png', status: 'normal' ,phone:'9035193777' },
  { id: 13, name: 'CurePlus Hospital Halli Mysore ', image: '/halli/halli.png', status: 'popular' ,phone:'08175-273114' },
];
