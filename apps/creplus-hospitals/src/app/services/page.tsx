  ...
  return (
    <>
      <div className="relative max-w-7xl mx-auto px-6 py-16 text-gray-800">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-blue-900">Our Healthcare Services</h1>
        ...
        >
          ...
          <Link href="/contact">
            <button className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-700 text-white rounded-full hover:bg-blue-800 transition">
