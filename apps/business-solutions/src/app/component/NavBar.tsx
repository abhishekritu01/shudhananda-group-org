...
//   return (
//     <header className="bg-orange-600 text-white fixed w-full top-0 z-50 shadow-lg">
//       <div className="container mx-auto flex justify-between items-center px-6 py-4">
//         <div className="flex items-center space-x-3">
//           <Image src="/SBPL.png" alt="SBPL Logo" width={60} height={50} className="rounded-full z-10" priority={true} />
...
//       <div
//         ref={menuRef}
//         className={`absolute top-16 left-0 w-full bg-orange-700 shadow-md p-6 transition-all duration-300 ease-in-out z-50 ${
...
//         <div className="flex items-center space-x-3">
//           <Image src="/SBPL.png" alt="SBPL Logo" width={60} height={50} className="rounded-full z-10" priority={true} />
//           <h1 className="text-sm md:text-xl font-semibold text-orange-600 tracking-wide">
//             Sudhanand Business Solutions
//           </h1>
//         </div>
...
//       <div
//         ref={menuRef}
//         className={`absolute top-16 left-0 w-full bg-white shadow-md p-6 transition-all duration-300 ease-in-out z-50 ${
//           isOpen ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"
//         } md:hidden`}
//       >
//         <nav className="flex flex-col space-y-4 text-center">
...
//           <Link href="/careers" className="text-orange-600 hover:text-orange-800 transition-colors duration-300">
//           careers
//           </Link>
//           <Link href="/about" className="text-orange-600 hover:text-orange-800 transition-colors duration-300">
//             About Us
//           </Link>
//         </div>
//         {/* Mobile Menu Button */}
