...
//         <section id="about" className="p-10 bg-orange-50 text-orange-800">
        ...
        <section id="about" className="p-10 bg-white text-orange-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                {[
                    ...
                    { icon: FaBriefcase, title: "Our Growth Story", text: "2010 – Founded to provide affordable healthcare.\n2012 – Expanded to 600,000+ members.\n2019 – Entered IT & ITES sector.\n2024 – Rebranded as SBPL for multi-sector expansion." },
